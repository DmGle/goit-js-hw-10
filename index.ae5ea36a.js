...
let i=r?Object.getOwnPropertyNames(t):Object.keys(t),s=i.length;for(n=0;n<s;n++)o=i[n],e.call(null,t[o],o,t)}}}function U(t,e){let r;e=e.toLowerCase();let n=Object.keys(t),o=n.length;for(;o-- >0;)if(e===(r=n[o]).toLowerCase())return r;return null}const C=/*eslint no-undef:0*/"undefined"!=typeof globalThis?globalThis:"undefined"!=typeof self?self:"undefined"!=typeof window?window:s,I=t=>!y(t)&&t!==C,x=(e="undefined"!=typeof Uint8Array&&l(Uint8Array),t=>e&&t instanceof e),N=h("HTMLFormElement"),L=(({hasOwnProperty:t})=>(e,r)=>t.call(e,r))(Object.prototype),j=h("RegExp"),P=(t,e)=>{let r=Object.getOwnPropertyDescriptors(t),n={};T(r,(r,o)=>{let i;!1!==(i=e(r,o,t))&&(n[o]=i||r)}),Object.defineProperties(t,n)},_="abcdefghijklmnopqrstuvwxyz",F="0123456789",k={DIGIT:F,ALPHA:_,ALPHA_DIGIT:_+_.toUpperCase()+F},D=h("AsyncFunction");var M={isArray:d,isArrayBuffer:g,isBuffer:/**
 * Determine if a value is a Buffer
 *
 * @param {*} val The value to test
 *
 * @returns {boolean} True if value is a Buffer, otherwise false
 */function(t){return null!==t&&!y(t)&&null!==t.constructor&&!y(t.constructor)&&b(t.constructor.isBuffer)&&t.constructor.isBuffer(t)},isFormData:t=>{let e;return t&&("function"==typeof FormData&&t instanceof FormData||b(t.append)&&("formdata"===(e=c(t))||// detect form-data instance
 ...
 */function(t){return"undefined"!=typeof ArrayBuffer&&ArrayBuffer.isView?ArrayBuffer.isView(t):t&&t.buffer&&g(t.buffer)},isString:m,isNumber:E,isBoolean:t=>!0===t||!1===t,isObject:w,isPlainObject:A,isUndefined:y,isDate:O,isFile:R,isBlob:B,isRegExp:j,isFunction:b,isStream:t=>w(t)&&b(t.pipe),isURLSearchParams:S,isTypedArray:x,isFileList:v,forEach:T,merge:/**
 ...
 *
 * @returns {boolean}
 */function(t){return!!(t&&b(t.append)&&"FormData"===t[Symbol.toStringTag]&&t[Symbol.iterator])},toJSONObject:t=>{let e=Array(10),r=(t,n)=>{if(w(t)){if(e.indexOf(t)>=0)return;if(!("toJSON"in t)){e[n]=t;let o=d(t)?[]:{};return T(t,(t,e)=>{let i=r(t,n+1);y(i)||(o[e]=i)}),e[n]=void 0,o}}return t};return r(t,0)},isAsyncFn:D,isThenable:t=>t&&(w(t)||b(t))&&b(t.then)&&b(t.catch)};/**
 ...
 **/Q.alloc=function(t,e,r){return(tt(t),t<=0)?Y(t):void 0!==e?"string"==typeof r?Y(t).fill(e,r):Y(t).fill(e):Y(t)},/**
...
function tI(t){return"undefined"==typeof BigInt?tx:t}function tx(){throw Error("BigInt not supported")}/**
 * Determines if the given thing is a array or js object.
 *
 * @param {string} thing - The object or array to be visited.
 *
 * @returns {boolean}
 */function tN(t){return M.isPlainObject(t)||M.isArray(t)}/**
...
t=tL(t),!r&&e?"["+t+"]":t)}).join(r?".":""):e}const tP=M.toFlatObject(M,{},null,function(t){return/^is[A-Z]/.test(t)});var t_=/**
...
t=JSON.stringify(t);else{var u;if(M.isArray(t)&&(u=t,M.isArray(u)&&!u.some(tN))||(M.isFileList(t)||M.endsWith(r,"[]"))&&(a=M.toArray(t)))return(// eslint-disable-next-line no-param-reassign
r=tL(r),a.forEach(function(t,n){M.isUndefined(t)||null===t||e.append(!0===s?tj([r],n,i):null===s?r:r+"[]",f(t))}),!1)}}return!!tN(t)||(e.append(tj(o,r,i),f(t)),!1)}let c=[],h=Object.assign(tP,{defaultVisitor:l,convertValue:f,isVisitable:tN});if(!M.isObject(t))throw TypeError("data must be an object");return!function t(r,n){if(!M.isUndefined(r)){if(-1!==c.indexOf(r))throw Error("Circular reference detected in "+n.join("."));c.push(r),M.forEach(r,function(r,i){let s=!(M.isUndefined(r)||null===r)&&o.call(e,r,M.isString(i)?i.trim():i,n,h);!0===s&&t(r,n?n.concat(i):[i])}),c.pop()}}(t),e};/**
 ...
 *
 * @returns {void}
 */function tk(t,e){this._pairs=[],t&&t_(t,this,e)}const tD=tk.prototype;/**
 ...
 */function tM(t){return encodeURIComponent(t).replace(/%3A/gi,":").replace(/%24/g,"$").replace(/%2C/gi,",").replace(/%20/g,"+").replace(/%5B/gi,"[").replace(/%5D/gi,"]")}function t$(t,e,r){let n;/*eslint no-param-reassign:0*/if(!e)return t;let o=r&&r.encode||tM,i=r&&r.serialize;if(n=i?i(e,r):M.isURLSearchParams(e)?e.toString():new tk(e,r).toString(o)){let e=t.indexOf("#");-1!==e&&(t=t.slice(0,e)),t+=(-1===t.indexOf("?")?"?":"&")+n}return t}tD.append=function(t,e){this._pairs.push([t,e])},tD.toString=function(t){let e=t?function(e){return t.call(this,e,tF)}:tF;return this._pairs.map(function(t){return e(t[0])+"="+e(t[1])},"").join("&")};var tq=class{/**
   ...
   *
   * @returns {void}
   */forEach(t){M.forEach(this.handlers,function(e){null!==e&&t(e)})}constructor(){this.handlers=[]}},tz={silentJSONParsing:!0,forcedJSONParsing:!0,clarifyTimeoutError:!1},tH="undefined"!=typeof URLSearchParams?URLSearchParams:tk,tJ="undefined"!=typeof FormData?FormData:null,tV="undefined"!=typeof Blob?Blob:null,tW={};a(tW,"hasBrowserEnv",function(){return tG}),a(tW,"hasStandardBrowserEnv",function(){return tK}),a(tW,"hasStandardBrowserWebWorkerEnv",function(){return tX});const tG="undefined"!=typeof window&&"undefined"!=typeof document,tK=(r="undefined"!=typeof navigator&&navigator.product,tG&&0>["ReactNative","NativeScript","NS"].indexOf(r)),tX="undefined"!=typeof WorkerGlobalScope&&// eslint-disable-next-line no-undef
self instanceof WorkerGlobalScope&&"function"==typeof self.importScripts;var tY={...tW,isBrowser:!0,classes:{URLSearchParams:tH,FormData:tJ,Blob:tV},protocols:["http","https","file","blob","url","data"]},tQ=/**
 ...
 */function(t,e,r){if(M.isString(t))try{return(0,JSON.parse)(t),M.trim(t)}catch(t){if("SyntaxError"!==t.name)throw t}return(0,JSON.stringify)(t)}(t)):t}],transformResponse:[function(t){let e=this.transitional||tZ.transitional,r=e&&e.forcedJSONParsing,n="json"===this.responseType;if(t&&M.isString(t)&&(r&&!this.responseType||n)){let r=e&&e.silentJSONParsing;try{return JSON.parse(t)}catch(t){if(!r&&n){if("SyntaxError"===t.name)throw $.from(t,$.ERR_BAD_RESPONSE,this,null,this.response);throw t}}}return t}],/**
   ...
   */timeout:0,xsrfCookieName:"XSRF-TOKEN",xsrfHeaderName:"X-XSRF-TOKEN",maxContentLength:-1,maxBodyLength:-1,env:{FormData:tY.classes.FormData,Blob:tY.classes.Blob},validateStatus:function(t){return t>=200&&t<300},headers:{common:{Accept:"application/json, text/plain, */*","Content-Type":void 0}}};M.forEach(["delete","get","head","post","put","patch"],t=>{tZ.headers[t]={}});// RawAxiosHeaders whose duplicates are ignored by node
...
return{get:()=>t,set(t){this[r]=t}}}),M.freezeMethods(t3),M.inherits(et,$,{__CANCEL__:!0});var ee=tY.hasStandardBrowserEnv?{write(t,e,r,n,o,i){let s=[t+"="+encodeURIComponent(e)];M.isNumber(r)&&s.push("expires="+new Date(r).toGMTString()),M.isString(n)&&s.push("path="+n),M.isString(o)&&s.push("domain="+o),!0===i&&s.push("secure"),document.cookie=s.join("; ")},read(t){let e=document.cookie.match(RegExp("(^|;\\s*)("+t+")=([^;]*)"));return e?decodeURIComponent(e[3]):null},remove(t){this.write(t,"",Date.now()-864e5)}}:{write(){},read:()=>null,remove(){}};function er(t,e){return t&&!/^([a-z][a-z\d+\-.]*:)?\/\//i.test(e)?e?t.replace(/\/+$/,"")+"/"+e.replace(/^\/+/,""):t:e}var en=tY.hasStandardBrowserEnv?// whether the request URL is of the same origin as current location.
...
l.ontimeout=function(){let e=t.timeout?"timeout of "+t.timeout+"ms exceeded":"timeout exceeded",n=t.transitional||tz;t.timeoutErrorMessage&&(e=t.timeoutErrorMessage),r(new $(e,n.clarifyTimeoutError?$.ETIMEDOUT:$.ECONNABORTED,t,l)),// Clean up request
l=null},tY.hasStandardBrowserEnv&&(u&&M.isFunction(u)&&(u=u(t)),u||!1!==u&&en(c))){// Add xsrf header
let e=t.xsrfHeaderName&&t.xsrfCookieName&&ee.read(t.xsrfCookieName);e&&s.set(t.xsrfHeaderName,e)}// Remove Content-Type if data is undefined
void 0===i&&s.setContentType(null),"setRequestHeader"in l&&M.forEach(s.toJSON(),function(t,e){l.setRequestHeader(e,t)}),M.isUndefined(t.withCredentials)||(l.withCredentials=!!t.withCredentials),a&&"json"!==a&&(l.responseType=t.responseType),"function"==typeof t.onDownloadProgress&&l.addEventListener("progress",ei(t.onDownloadProgress,!0)),"function"==typeof t.onUploadProgress&&l.upload&&l.upload.addEventListener("progress",ei(t.onUploadProgress)),(t.cancelToken||t.signal)&&(// Handle cancellation
// eslint-disable-next-line func-names
n=e=>{l&&(r(!e||e.type?new et(null,t,l):e),l.abort(),l=null)},t.cancelToken&&t.cancelToken.subscribe(n),t.signal&&(t.signal.aborted?n():t.signal.addEventListener("abort",n)));let p=function(t){let e=/^([-+\w]{1,25})(:?\/\/|:)/.exec(t);return e&&e[1]||""}(c);if(p&&-1===tY.protocols.indexOf(p)){r(new $("Unsupported protocol "+p+":",$.ERR_BAD_REQUEST,t));return}// Send the request
l.send(i||null)})};const eu={http:null,xhr:ea};M.forEach(eu,(t,e)=>{if(t){try{Object.defineProperty(t,"name",{value:e})}catch(t){// eslint-disable-next-line no-empty
...
function a(r,o,i){return i in e?n(r,o):i in t?n(void 0,r):void 0}let u={url:i,method:i,data:i,baseURL:s,transformRequest:s,transformResponse:s,paramsSerializer:s,timeout:s,timeoutMessage:s,withCredentials:s,withXSRFToken:s,adapter:s,responseType:s,xsrfCookieName:s,xsrfHeaderName:s,onUploadProgress:s,onDownloadProgress:s,decompress:s,maxContentLength:s,maxBodyLength:s,beforeRedirect:s,transport:s,httpAgent:s,httpsAgent:s,cancelToken:s,socketPath:s,responseEncoding:s,validateStatus:a,headers:(t,e)=>o(ed(t),ed(e),!0)};return M.forEach(Object.keys(Object.assign({},t,e)),function(n){let i=u[n]||o,s=i(t[n],e[n],n);M.isUndefined(s)&&i!==a||(r[n]=s)}),r}const eg="1.6.2",em={};// eslint-disable-next-line func-names
 ...
 *
 * @returns {function}
 */em.transitional=function(t,e,r){function n(t,e){return"[Axios v"+eg+"] Transitional option '"+t+"'"+e+(r?". "+r:"")}// eslint-disable-next-line func-names
 ...
 */class eA{/**
   ...
   */request(t,e){let r,n;"string"==typeof t?(e=e||{}).url=t:e=t||{},e=ey(this.defaults,e);let{transitional:o,paramsSerializer:i,headers:s}=e;void 0!==o&&eE.assertOptions(o,{silentJSONParsing:ew.transitional(ew.boolean),forcedJSONParsing:ew.transitional(ew.boolean),clarifyTimeoutError:ew.transitional(ew.boolean)},!1),null!=i&&(M.isFunction(i)?e.paramsSerializer={serialize:i}:eE.assertOptions(i,{encode:ew.function,serialize:ew.function},!0)),// Set config.method
...
let u=[],f=!0;this.interceptors.request.forEach(function(t){("function"!=typeof t.runWhen||!1!==t.runWhen(e))&&(f=f&&t.synchronous,u.unshift(t.fulfilled,t.rejected))});let l=[];this.interceptors.response.forEach(function(t){l.push(t.fulfilled,t.rejected)});let c=0;if(!f){let t=[ep.bind(this),void 0];for(t.unshift.apply(t,u),t.push.apply(t,l),n=t.length,r=Promise.resolve(e);c<n;)r=r.then(t[c++],t[c++]);return r}n=u.length;let h=e;for(c=0;c<n;){let t=u[c++],e=u[c++];try{h=t(h)}catch(t){e.call(this,t);break}}try{r=ep.call(this,h)}catch(t){return Promise.reject(t)}for(c=0,n=l.length;c<n;)r=r.then(l[c++],l[c++]);return r}getUri(t){t=ey(this.defaults,t);let e=er(t.baseURL,t.url);return t$(e,t.params,t.paramsSerializer)}constructor(t){this.defaults=t,this.interceptors={request:new tq,response:new tq}}}M.forEach(["delete","get","head","options"],function(t){/*eslint func-names:0*/eA.prototype[t]=function(e,r){return this.request(ey(r||{},{method:t,url:e,data:(r||{}).data}))}}),M.forEach(["post","put","patch"],function(t){/*eslint func-names:0*/function e(e){return function(r,n,o){return this.request(ey(o||{},{method:t,headers:e?{"Content-Type":"multipart/form-data"}:{},url:r,data:n}))}}eA.prototype[t]=e(),eA.prototype[t+"Form"]=e(!0)});/**
 ...
 */class eO{/**
   ...
   */static source(){let t;let e=new eO(function(e){t=e});return{token:e,cancel:t}}constructor(t){let e;if("function"!=typeof t)throw TypeError("executor must be a function.");this.promise=new Promise(function(t){e=t});let r=this;// eslint-disable-next-line func-names
...
n.create=function(r){return t(ey(e,r))},n}(tZ);// Expose Axios class to allow class inheritance
eB.Axios=eA,// Expose Cancel & CancelToken
eB.CanceledError=et,eB.CancelToken=eO,eB.isCancel=t9,eB.VERSION=eg,eB.toFormData=t_,// Expose AxiosError class
...
eB.mergeConfig=ey,eB.AxiosHeaders=t3,eB.formToJSON=t=>tQ(M.isHTMLForm(t)?new FormData(t):t),eB.getAdapter=ec.getAdapter,eB.HttpStatusCode=eR,eB.default=eB;// This module is intended to unwrap Axios default export as named.
// Keep top-level export same with static properties
// so that it can keep same with es module or cjs
const{Axios:ev,AxiosError:eS,CanceledError:eT,isCancel:eU,CancelToken:eC,VERSION:eI,all:ex,Cancel:eN,isAxiosError:eL,spread:ej,toFormData:eP,AxiosHeaders:e_,HttpStatusCode:eF,formToJSON:ek,getAdapter:eD,mergeConfig:eM}=eB;async function e$(){try{let t=await eB.get("https://api.thecatapi.com/v1/breeds");return t.data}catch(t){throw console.error("Error fetching cat breeds:",t.message),t}}async function eq(t){try{let e=await eB.get(`https://api.thecatapi.com/v1/images/search?breed_ids=${t}`);return e.data}catch(t){throw console.error("Error fetching cat by breed:",t.message),t}}eB.defaults.headers.common["x-api-key"]="live_OL8SUtRIAGOzXkWDSShPMT170hWdbM4qS9Xi0H633A3UX4kkSigjkNpFAyrQEhlJ",document.addEventListener("DOMContentLoaded",async function(){let t=document.querySelector(".breed-select"),e=document.querySelector(".loader"),r=document.querySelector(".loader"),n=document.querySelector(".error"),o=document.querySelector(".cat-info");try{e.style.display="block";let n=await e$();n.forEach(e=>{let r=document.createElement("option");r.value=e.id,r.text=e.name,t.appendChild(r)}),e.style.display="none",t.addEventListener("change",async function(){let e=t.value;if(e)try{r.style.display="block";let t=await eq(e);o.innerHTML=`
              <img src="${t[0].url}" alt="Cat Image">
              <p>Breed: ${n.find(t=>t.id===e).name}</p>
              <p>Description: ${t[0].breeds[0].description}</p>
              <p>Temperament: ${t[0].breeds[0].temperament}</p>
            `,r.style.display="none",o.style.display="block"}catch(t){console.error(t),r.style.display="none",t.style.display="block",o.style.display="none"}})}catch(t){console.error(t),e.style.display="none",n.style.display="block"}});//# sourceMappingURL=index.ae5ea36a.js.map

//# sourceMappingURL=index.ae5ea36a.js.map
